...
export const renderContactPage = function () {
  ...
  const contactDetailsWrapper = createDOMElement(
    "div",
    "contact-details-wrapper",
  );
  contactDetailsWrapper.appendChild(
    createDOMElement("h1", "", "Where you can find us?"),
  );

  const contactDetails = createDOMElement("div", "contact-details");
  contactDetails.appendChild(
    createDOMElement("p", "", "Adress: Street 1, Athens"),
  );
  contactDetails.appendChild(
    createDOMElement("p", "", "Kitchen hours: 11:30 - 23:30"),
  );
  contactDetails.appendChild(
    createDOMElement("p", "", "Phone: +30 210 123 4567"),
  );
  contactDetails.appendChild(
    createDOMElement("p", "", "Email: example@restaurant.com"),
  );
